  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      if (data.error) {
        ...
        //update distributors dropdown for earn points transaction
        $('.documentList').html(function() {
          ...
          if(documentsData)
          {
            for (var i = 0; i < documentsData.length; i++) {
              ...
              str = str + '<tr><td width="50%"> <a href=/api/viewfile?documentId='+documentsData[i].documentId +'&cardId='+formCardId +'&distributorId='+formAccountNum+' target=”_blank” >' + documentsData[i].docName + ' </a></td><td width="50%"> ' + documentsData[i].docStatus + '</td></tr>';
            }
          }
        ...
        //update distributors dropdown for use points transaction
        $('.approveRequestList').html(function() {
          var str = '<tr><th width="30%">Document Name</th><th width="30%">Requesting Distributor</th><th width="30%">approve</th></tr>';
          ...
          if(approveRequestList)
          {
            for (var i = 0; i < approveRequestList.length; i++) {
              ...
              {
                str = str + '<tr><td width="30%">' + approveRequestList[i].docName + '</td><td width="30%"> ' + approveRequestList[i].distributor + '</td> <td width="30%"> Approved </td>  </tr>';
              }
              else {
                str = str + '<tr><td width="30%">' + approveRequestList[i].docName + '</td><td width="30%"> ' + approveRequestList[i].distributor + '</td> <td width="30%"> <a><img  width="25" height="25" src="./img/approveicon.png"  onclick="return approveAcessRequest(\''+approveRequestList[i].requestId+'\');">Click to approve</img></a> </td>  </tr>';
              }
            }
          }
